...
import com.dcrux.haufen.refimplementation.element.annotation.AnnotationElement;
...
public class AnnotatedElement extends BaseElement implements IInternalElement, IAnnotatedElement {
    ...
    public AnnotatedElement(boolean initialized) {
        if (initialized) {
    ...
    public void initialize(IDataInput data, byte subtype, IElementProvider elementProvider) {
        ...
        final Iterator<IInternalElement> iterator = CommonListWriter.getInstance().read(data, withAdditionalHeader, elementProvider);
