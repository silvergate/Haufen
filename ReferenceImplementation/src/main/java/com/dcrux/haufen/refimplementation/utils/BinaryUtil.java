...
import com.dcrux.haufen.refimplementation.common.BaseTypeNumbers;
...
public class BinaryUtil {
    ...
    public static void readHead(IDataInput dataInput, Head outHead) {
        ...
        outHead.setType(BaseTypeNumbers.fromNumber(baseType));
    ...
    public static void writeHead(IDataOutput dataOutput, Head inHead) {
        //bbbbbssa
        byte baseType = BaseTypeNumbers.toNumber(inHead.getType());
