 ...
 */
public class SetElement extends BaseElement implements IInternalElement {

    private Set<IInternalElement> memory;

    public SetElement(IDataInput dataInput, byte subtype, IElementProvider elementProvider) {
